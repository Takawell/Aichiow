            ...
            <div className="bg-white/5 backdrop-blur-xl rounded-2xl p-6 md:p-8 border border-white/10 shadow-2xl">
              ...
              anime.nextAiringEpisode && (
                ...
                >
                  ...
                  <div className="relative backdrop-blur-sm px-6 py-5 border border-white/10">
                    <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                      <div className="flex items-center gap-4">
                        <div className="w-14 h-14 rounded-xl bg-gradient-to-br from-blue-500/30 to-purple-500/30 flex items-center justify-center border border-blue-400/40 shadow-lg">
                      ...
                      <div className="flex items-center gap-4">
                        ...
                        <div className="md:text-right">
                          ...
                          <p className="text-base md:text-lg font-bold bg-gradient-to-r from-blue-300 via-purple-300 to-pink-300 bg-clip-text text-transparent">
                  ...
                  {Array.from({ length: totalEpisodes }).map((_, idx) => {
                    ...
                    return (
                      <a
                        key={ep}
                        href={`/watch/soon`}
                        className="bg-white/5 hover:bg-white/10 text-white p-3 rounded-lg border border-white/10 hover:border-blue-400/50 text-center transition-all duration-200 shadow-lg hover:shadow-blue-500/20 hover:scale-105"
                      >
