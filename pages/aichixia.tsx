...
export default function AichixiaPage() {
  ...
  return (
    <main className="flex flex-col items-center min-h-screen bg-gradient-to-br from-[#050b1b] via-[#0a1228] to-[#050b1b] text-sky-100">
      <div className="w-full max-w-5xl flex flex-col h-screen mx-3 sm:mx-6">
        <header className="p-4 border-b border-sky-800 bg-black/20 backdrop-blur-md rounded-b-xl shadow-md flex items-center justify-between sticky top-0 z-20">
          <div className="flex items-center gap-3">
            <div className="relative w-11 h-11 sm:w-12 sm:h-12 rounded-full ring-2 ring-sky-500 overflow-hidden shadow-lg">
        ...
        <section className="flex-1 overflow-y-auto px-4 sm:px-6 py-5 space-y-4 scroll-smooth">
          {messages.map((msg, i) => (
            <motion.div
              key={i}
            ...
            >
              ...
              {msg.type === "image" && typeof msg.content === "string" && (
                <div className="rounded-2xl overflow-hidden border border-sky-700/40 shadow-md">
                  <Image
                    src={msg.content}
                    alt="uploaded"
                    width={250}
        ...
        <footer className="p-4 bg-gradient-to-t from-[#071026]/60 via-transparent backdrop-blur-sm sticky bottom-0 rounded-t-xl">
      ...
      <AnimatePresence>
        {scanOpen && (
          ...
          >
            <motion.div
              className="relative bg-gradient-to-b from-[#151518]/90 to-[#0f0f10]/90 rounded-3xl p-8 w-full max-w-md text-center shadow-2xl border border-white/10"
