...
import { MdArrowBack, MdFullscreen, MdFullscreenExit, MdArrowUpward, MdClose, MdBlurOn, MdBlurOff, MdLock, MdLogin, MdPersonAdd } from 'react-icons/md'
            ...
            >
              ...
              <div className="relative p-8 space-y-6">
                ...
                >
                  ...
                  >
                    <MdLogin className="group-hover:rotate-12 transition-transform" size={20} />
                    Login to Account
                  </button>
                  ...
                  >
                    <MdPersonAdd className="group-hover:rotate-12 transition-transform" size={20} />
                    Create New Account
                  </button>
                </motion.div>
            ...
            {mode === 'scroll' && (
              <div className="space-y-6">
                {images.map((src, idx) => (
                  ...
                  >
                    <div className={`relative overflow-hidden rounded-lg shadow-lg border border-neutral-800 ${blurredPages.has(idx) ? 'ring-2 ring-sky-500/50' : ''}`}>
                      <img
                        src={src}
                        alt={`Page ${idx + 1}`}
                        loading="lazy"
                        className={`w-full h-auto object-contain transition-all duration-500 ${
                          blurredPages.has(idx) ? 'blur-xl scale-105' : 'blur-0 scale-100 hover:scale-[1.01]'
                        }`}
                      />
