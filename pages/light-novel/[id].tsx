  ...
  return (
    <>
      ...
      <div className="relative min-h-screen text-white">
        {/* Background gradient (di bawah cover) */}
        <div className="absolute inset-0 top-40 md:top-60 bg-gradient-to-b from-black via-gray-900 to-gray-950 -z-10" />
        ...
        <div className="relative w-full">
          <img
            ...
            className="w-full h-[320px] md:h-[450px] object-cover relative z-10"
          />
          <div className="absolute bottom-6 left-6 flex items-end gap-6 z-20">
            <motion.img
        ...
        {/* Detail Section */}
        <section className="max-w-6xl mx-auto px-4 md:px-8 py-10 space-y-8 relative z-20">
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
        ...
        {novel.characters && novel.characters?.length > 0 && (
          <section className="max-w-6xl mx-auto px-4 md:px-8 py-6 sm:py-8 relative z-20">
        ...
        {/* Back Button */}
        <div className="max-w-6xl mx-auto px-4 md:px-8 py-10 relative z-20">
          <Link
            href="/light-novel"
