  ...
  const t = {
    id: {
      ...
      notices: [
        ...
        'Jika menemukan bug, laporkan melalui halaman Profil → Feedback.',
    ...
    en: {
      ...
      notices: [
        ...
        'If you find bugs, please report via Profile → Feedback.',
  ...
  return (
    <>
      <button
        ...
        className="fixed bottom-6 right-6 z-40 bg-gradient-to-r from-yellow-500 to-yellow-400 text-black font-semibold px-4 py-2 rounded-full shadow-lg hover:from-yellow-400 hover:to-yellow-300 transition-all flex items-center gap-2"
      >
        <Bell className="w-5 h-5" />
        {lang === 'id' ? 'Lihat Update' : 'View Updates'}
      </button>
            ...
            >
              ...
              <div className="flex items-center justify-center gap-2 mt-3">
                ...
                >
                  <motion.div
                    layout
                    className={`absolute w-1/2 h-6 bg-yellow-500 rounded-full transition-all ${
              ...
              <div className="p-4 border-t border-neutral-800 flex justify-end">
                <button
                  onClick={handleClose}
                  className="bg-yellow-500 hover:bg-yellow-600 text-black px-5 py-2 rounded-full font-semibold transition-all"
                >
                  {t[lang].close}
                </button>
              </div>
